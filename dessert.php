...
<head>
    ...
    <title>Student Recipe | Dessert</title>
</head>
<body>
...
<?php
    $id = $_GET["id"];
    $main = "SELECT id, picture, name, prep_time, cook_time, ingredient, steps, video_url,videoname FROM recipes WHERE $id = id AND category='dessert'";
