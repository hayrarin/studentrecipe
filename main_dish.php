...
<head>
    ...
    <title>Student Recipe | Main Dish</title>
</head>
<body>
...
<?php
    $id = $_GET["id"];
    $main = "SELECT id, picture, name, prep_time, cook_time, ingredient, steps, video_url,videoname FROM recipes WHERE $id = id AND category='main_dish'";
